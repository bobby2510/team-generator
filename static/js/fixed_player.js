let get_fixed_players = function(team1,team2,index_one_list,index_two_list,series_index)
{
    ...
    team1_data.forEach((player)=>
    {
        ...
        outer_div.classList.add('d-flex','justify-content-between','align-items-center','border-grey','fixed_team_one_data')
    ...
    team2_data.forEach((player)=>
    {
        ...
        outer_div.appendChild(img)
        outer_div.appendChild(inner_div1)
        outer_div.classList.add('d-flex','justify-content-between','align-items-center','border-grey','fixed_team_two_data')
        outer_div.style.width="200px";
        outer_div.style.marginTop="10px"
        outer_div.style.marginBottom="10px"
